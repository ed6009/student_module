...
const Carousal = () => {
  return (
    <>
      <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 mt-20 mb-24">
        <div className="grid gap-4 md:grid-cols-2 md:gap-8 xl:gap-20 md:items-center">
          <div>
            <h1 className="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">
              Start your journey with <span className="text-blue-600">ED Tech</span>
            </h1>
            ...
            <div className="grid w-full gap-3 mt-7 sm:inline-flex">
              <a
                className="inline-flex items-center justify-center px-4 py-3 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-lg gap-x-2 hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none"
                href="#"
              >
                Get started
                <svg
          ...
          <div className="relative ms-4">
            <img
              ...
              src="https://images.unsplash.com/photo-1523240795612-9a054b0db644?q=80&w=3270&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              alt="Hero Image"
            />
      ...
      >
        <div className="relative w-full overflow-hidden bg-white rounded-lg hs-carousel min-h-64">
          <div className="absolute top-0 bottom-0 flex transition-transform duration-700 opacity-0 hs-carousel-body start-0 flex-nowrap">
                  ...
                  <blockquote className="relative border-s-4 ps-4 sm:ps-6 dark:border-neutral-700">
                    <p className="text-gray-800 sm:text-xl dark:text-white">
                      <em>
                        ...
                        purchase so far. The documentation is outstanding -
                        clear and detailed.
                      </em>
                    </p>
            ...
            <div className="hs-carousel-slide">
              <div className="flex justify-center h-full p-6 bg-gray-200 dark:bg-neutral-800">
                <span className="self-center text-4xl text-gray-800 transition duration-700 dark:text-white">
                  <blockquote className="relative border-s-4 ps-4 sm:ps-6 dark:border-neutral-700">
                    <p className="text-gray-800 sm:text-xl dark:text-white">
                      <em>
            ...
            <div className="hs-carousel-slide">
              <div className="flex justify-center h-full p-6 bg-gray-300 dark:bg-neutral-700">
                <span className="self-center text-4xl text-gray-800 transition duration-700 dark:text-white">
                  <blockquote className="relative border-s-4 ps-4 sm:ps-6 dark:border-neutral-700">
                    <p className="text-gray-800 sm:text-xl dark:text-white">
                      <em>
        ...
        <div className="absolute flex justify-center space-x-2 hs-carousel-pagination bottom-3 start-0 end-0">
          <span className="border border-gray-400 rounded-full cursor-pointer hs-carousel-active:bg-blue-700 hs-carousel-active:border-blue-700 size-3 dark:border-neutral-600 dark:hs-carousel-active:bg-blue-500 dark:hs-carousel-active:border-blue-500"></span>
          <span className="border border-gray-400 rounded-full cursor-pointer hs-carousel-active:bg-blue-700 hs-carousel-active:border-blue-700 size-3 dark:border-neutral-600 dark:hs-carousel-active:bg-blue-500 dark:hs-carousel-active:border-blue-500"></span>
          <span className="border border-gray-400 rounded-full cursor-pointer hs-carousel-active:bg-blue-700 hs-carousel-active:border-blue-700 size-3 dark:border-neutral-600 dark:hs-carousel-active:bg-blue-500 dark:hs-carousel-active:border-blue-500"></span>
        </div>
      </div>
